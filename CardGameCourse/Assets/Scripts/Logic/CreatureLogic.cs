...
public class CreatureLogic: ICharacter 
{
    ...
    private bool hiddenAttack;
    public bool HiddenAttack
    {
        get { return hiddenAttack; }
        set { hiddenAttack = value; }
    }

    private bool powerAOrB;
    public bool PowerAOrB
    {
        get { return powerAOrB; }
        set { powerAOrB = value; }
    }

    private bool activateddefeffect;
    public bool ActivatedDefEffect
    {
        get { return activateddefeffect; }
        set { activateddefeffect = value; }
    }
    ...
    public CreatureLogic(Player owner, CardAsset ca)
    {
        ...
        Health = ca.MaxHealth;
        baseAttack = owner.NormalAttack;
        attacksForOneTurn = ca.AttacksForOneTurn;
        hiddenAttack = false;
        powerAOrB = false;
        activateddefeffect = false;
