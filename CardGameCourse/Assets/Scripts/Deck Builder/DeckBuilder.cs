...
public class DeckBuilder : MonoBehaviour 
{
    ...
    public int SameCardLimit = 6;
    public int AmountOfCardsInDeck = 50;
    ...
    public void DoneButtonHandler()
    {
        ...
        Debug.Log("In DoneButtonHandler");
    ...
    private void AddBasicCardsToDeck()
    {
        ...
        ca = CardCollection.Instance.GetCardAssetByName("Upper Center Attack");
        //Debug.Log("Name: " + ca.name);
        DeckBuildingScreen.Instance.BuilderScript.AddCard(ca);

        ca = CardCollection.Instance.GetCardAssetByName("Upper Right Attack");
        DeckBuildingScreen.Instance.BuilderScript.AddCard(ca);

        ca = CardCollection.Instance.GetCardAssetByName("Middle Left Attack");
        DeckBuildingScreen.Instance.BuilderScript.AddCard(ca);

        ca = CardCollection.Instance.GetCardAssetByName("Thrust");
        DeckBuildingScreen.Instance.BuilderScript.AddCard(ca);

        ca = CardCollection.Instance.GetCardAssetByName("Middle Right Attack");
        DeckBuildingScreen.Instance.BuilderScript.AddCard(ca);

        ca = CardCollection.Instance.GetCardAssetByName("Lower Left Attack");
        DeckBuildingScreen.Instance.BuilderScript.AddCard(ca);

        ca = CardCollection.Instance.GetCardAssetByName("Lower Center Attack");
        DeckBuildingScreen.Instance.BuilderScript.AddCard(ca);

        ca = CardCollection.Instance.GetCardAssetByName("Lower Right Attack");
        DeckBuildingScreen.Instance.BuilderScript.AddCard(ca);

        //Add 6 Defense cards
        ca = CardCollection.Instance.GetCardAssetByName("Upper Left Block");
        DeckBuildingScreen.Instance.BuilderScript.AddCard(ca);

        ca = CardCollection.Instance.GetCardAssetByName("Upper Center Block");
        DeckBuildingScreen.Instance.BuilderScript.AddCard(ca);
        ...
        ca = CardCollection.Instance.GetCardAssetByName("Lower Right Block");
        DeckBuildingScreen.Instance.BuilderScript.AddCard(ca);
    }
}
