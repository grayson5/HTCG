    ...
    void LoadDecksFromPlayerPrefs()
    {
        ...
        for(int i=0; i < 9; i++)
        {
            ...
            if (DeckAsCardNames.Length > 0 && PlayerPrefs.HasKey(characterKey) && PlayerPrefs.HasKey(deckNameKey))
            {
                ...
                Debug.Log("Loading Deck Name: " + deckNameKey);
                Debug.Log("Loading Char: " + characterKey);
